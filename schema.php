    ...
    return [
        ...
        'tvguide' => ['title' => 'TV Guide', 'file' => 'tvguide.php', 'fields' => [
            ...
            ['key' => 'PRIME_END', 'label' => 'Prime time end', 'type' => 'text', 'default' => '23:00',
             'help' => 'Local wall time — end is exclusive (default 11:00 PM)'],
            ['key' => 'CHANNEL_LABEL', 'label' => 'Channel column', 'type' => 'select',
             'options' => ['affiliate', 'callsign', 'broadcast', 'custom', 'none'], 'default' => 'affiliate',
             'help' => 'affiliate = callsign + network badge. custom = your channel # (from overrides below) + callsign. broadcast = OTA 3.1, 8.1, …'],
            ['key' => 'CHANNEL_NUMBERS', 'label' => 'Channel number overrides', 'type' => 'rows', 'keyed' => true,
             'columns' => [
                 ['key' => '_key', 'label' => 'Callsign', 'help' => 'e.g. WGVU, WOTV'],
                 ['key' => 'number', 'label' => 'Your channel #', 'help' => 'Cable/provider number on your lineup'],
             ],
             'help' => 'Maps callsign → your channel number (e.g. WGVU → 35). Used when Channel column is Custom, or as the badge in other modes.'],
