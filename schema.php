...
function admin_schema(): array
{
    ...
    return [
        ...
        'clocks' => ['title' => 'World Clocks', 'file' => 'clocks.php', 'fields' => [
            ['key' => 'TITLE', 'label' => 'Board title', 'type' => 'text', 'default' => 'World Clocks'],
            ['key' => 'SUBTITLE', 'label' => 'Subtitle', 'type' => 'text', 'default' => 'Local time around the world'],
            ['key' => 'CLOCKS', 'label' => 'Clocks', 'type' => 'rows', 'keyed' => true,
             'help' => 'IANA timezones (America/Detroit, Europe/London, UTC). Leave empty to use the built-in eight-city set. Mark one row Home to highlight the local clock.',
             'columns' => [
                 ['key' => '_key', 'label' => 'Key'],
                 ['key' => 'label', 'label' => 'City'],
                 ['key' => 'tz', 'label' => 'Timezone', 'wide' => true,
                  'help' => 'IANA name — e.g. America/Detroit or UTC'],
                 ['key' => 'home', 'label' => 'Home', 'type' => 'bool',
                  'help' => 'Highlight as the local clock'],
                 ['key' => 'off', 'label' => 'Off', 'type' => 'bool'],
             ]],
            ['key' => 'SHOW_ANALOG', 'label' => 'Show analog faces', 'type' => 'bool', 'default' => true],
            ['key' => 'SHOW_SECONDS', 'label' => 'Show seconds', 'type' => 'bool', 'default' => true],
            ['key' => 'SHOW_DATE', 'label' => 'Show weekday + date', 'type' => 'bool', 'default' => true],
            ['key' => 'SHOW_OFFSET', 'label' => 'Show UTC offset', 'type' => 'bool', 'default' => true],
            ['key' => 'MAX_CLOCKS', 'label' => 'Max clocks', 'type' => 'number',
             'help' => '1–12 cities on the wall (default 8)'],
            ['key' => 'RELOAD_SEC', 'label' => 'Page reload (seconds)', 'type' => 'number',
             'help' => '0 (default) — JS ticks live; rotation iframe reloads with the shell'],
            $tz,
        ]],
        ...
        'kev' => ['title' => 'CISA KEV', 'file' => 'kev.php', 'fields' => [
            ['key' => 'TITLE', 'label' => 'Board title', 'type' => 'text', 'default' => 'CISA KEV'],
            ['key' => 'SUBTITLE', 'label' => 'Subtitle', 'type' => 'text', 'default' => 'Known Exploited Vulnerabilities'],
            ['key' => 'MAX_ITEMS', 'label' => 'Row count', 'type' => 'number',
             'help' => 'Hero + list entries (4–12, default 8)'],
            ['key' => 'WARN_DAYS', 'label' => 'Due-soon window (days)', 'type' => 'number',
             'help' => 'Upcoming federal remediation deadlines within N days (0–90, default 14). Does not include overdue entries.'],
            ['key' => 'ADDED_DAYS', 'label' => 'New to KEV window (days)', 'type' => 'number',
             'help' => 'Prioritize catalog entries added within N days (default 90). Set 0 to disable recency filter.'],
            ['key' => 'WATCH_VENDORS', 'label' => 'Watch vendors', 'type' => 'text', 'wide' => true,
             'help' => 'Optional comma-separated vendor/product filters (e.g. microsoft, cisco, vmware). When set, matching stack entries can appear even outside the new-entry window. Blank = all vendors within the new-entry window.'],
            ['key' => 'SHOW_RANSOMWARE', 'label' => 'Show ransomware-linked KEV', 'type' => 'bool', 'default' => true],
            ['key' => 'USER_AGENT', 'label' => 'User-Agent', 'type' => 'text',
             'help' => 'Sent on CISA feed requests — include contact info'],
            ['key' => 'RELOAD_SEC', 'label' => 'Page reload (seconds)', 'type' => 'number',
             'help' => 'Direct view only — rotation iframe reloads with the shell'],
            $tz, $ttl('CISA KEV catalog JSON — default 3600s (1 h)'),
        ]],
        'certexp' => ['title' => 'TLS Cert Expiry', 'file' => 'certexp.php', 'fields' => [
            ['key' => 'TITLE', 'label' => 'Board title', 'type' => 'text', 'default' => 'TLS certificate expiry'],
            ['key' => 'SUBTITLE', 'label' => 'Subtitle', 'type' => 'text', 'default' => 'Configured hosts'],
            ['key' => 'HOSTS', 'label' => 'Hosts', 'type' => 'rows', 'keyed' => true,
             'help' => 'HTTPS endpoints to probe from the signage server (LAN hosts need outbound TLS from PHP).',
             'columns' => [
                 ['key' => '_key', 'label' => 'Key'],
                 ['key' => 'label', 'label' => 'Label'],
                 ['key' => 'host', 'label' => 'Host', 'wide' => true,
                  'help' => 'Hostname or IP — SNI uses this name'],
                 ['key' => 'port', 'label' => 'Port', 'help' => 'Default 443'],
                 ['key' => 'off', 'label' => 'Off', 'type' => 'bool'],
             ]],
            ['key' => 'WARN_DAYS', 'label' => 'Warn window (days)', 'type' => 'number',
             'help' => 'Highlight certs expiring within N days (1–90, default 30)'],
            ['key' => 'MAX_ITEMS', 'label' => 'List count', 'type' => 'number',
             'help' => 'Hero + list rows (4–16, default 10)'],
            ['key' => 'USER_AGENT', 'label' => 'User-Agent', 'type' => 'text',
             'help' => 'Reserved for future HTTP checks — TLS probe uses OpenSSL directly'],
            ['key' => 'RELOAD_SEC', 'label' => 'Page reload (seconds)', 'type' => 'number',
             'help' => 'Direct view only — rotation iframe reloads with the shell'],
            $tz, $ttl('Per-host TLS probe cache — default 3600s (1 h)'),
        ]],
        ...
        'glance' => ['title' => 'Today at a Glance', 'file' => 'glance.php', 'fields' => [
            ...
            ['key' => 'HEADLINES_1_RSS', 'label' => 'Left column RSS feed (site default)', 'type' => 'text',
             'help' => 'Feed key from RSS Stories. Used when page scrape fails, or as the primary source when set under Rotation → Kiosk settings for a display.'],
        ...
        'tvguide' => ['title' => 'TV Guide', 'file' => 'tvguide.php', 'fields' => [
            ...
            ['key' => 'PRIME_START', 'label' => 'Prime time start', 'type' => 'text', 'default' => '19:00',
             'help' => 'Local wall time — 8pm, 8:00 PM, 20:00, or 8 (evening = PM). Default 7:00 PM.'],
            ['key' => 'PRIME_END', 'label' => 'Prime time end', 'type' => 'text', 'default' => '23:00',
             'help' => 'Last hour shown is one hour before this time (end is exclusive). For 8–11 PM with an 11 PM column, use 12am / midnight.'],
            ['key' => 'CHANNEL_LABEL', 'label' => 'Channel column (fallback)', 'type' => 'select',
             'options' => ['custom', 'affiliate', 'callsign', 'broadcast', 'none'], 'default' => 'custom',
             'help' => 'Used only for channels without a number below. When a number is set, the wall always shows # + logo + callsign.'],
            ['key' => 'CHANNEL_NUMBERS', 'label' => 'Your channel numbers', 'type' => 'rows', 'keyed' => true,
             'columns' => [
                 ['key' => '_key', 'label' => 'Callsign'],
                 ['key' => 'number', 'label' => 'Your #'],
             ],
             'help' => 'Set in the table under Board settings (one row per station from your lineup).'],
            ['key' => 'BOARD_TITLE', 'label' => 'Default page title', 'type' => 'text'],
            ['key' => 'BOARD_SUB', 'label' => 'Default page subtitle', 'type' => 'text'],
            ['key' => 'RELOAD_SEC', 'label' => 'Page reload (seconds)', 'type' => 'number', 'default' => 3600,
             'help' => 'Direct view only — rotation iframe reloads with the shell'],
            $tz, $ttl('Schedules Direct listings — default 3600s'),
        ]],
        'video' => ['title' => 'Video Board', 'file' => 'video.php', 'fields' => [
            ['key' => 'VIDEOS', 'label' => 'Videos', 'type' => 'rows', 'keyed' => true,
             'columns' => [['key' => '_key', 'label' => 'Key', 'help' => 'used in ?v='],
                           ...
                           ['key' => 'live', 'label' => 'Live', 'type' => 'check',
                            'help' => 'Embed YouTube live (no download). Auto-detected from /live/ URLs.'],
            ...
            ['key' => 'LIVE_DWELL', 'label' => 'Live stream dwell (seconds)', 'type' => 'number', 'default' => 300,
             'help' => 'Rotation time for YouTube live embeds (no fixed length). Minimum 15 seconds.'],
        ...
        'grafana' => ['title' => 'Grafana', 'file' => 'grafana.php', 'fields' => [
            ...
            ['key' => 'JWT_SECRET', 'label' => 'JWT signing secret', 'type' => 'password',
             'help' => 'HS256 only — shared secret in Grafana jwk_set_file (kty oct)'],
            ['key' => 'JWT_PRIVATE_KEY', 'label' => 'JWT private key (PEM)', 'type' => 'textarea',
             'help' => 'RS256 only — RSA private key; public JWKS served at grafana-jwks.php'],
            ['key' => 'JWKS_PUBLIC_URL', 'label' => 'JWKS public URL', 'type' => 'text',
             'help' => 'Optional override — give this URL to Grafana Cloud support (default: …/grafana-jwks.php)'],
            ['key' => 'JWT_KID', 'label' => 'JWT key ID (kid)', 'type' => 'text', 'default' => 'signage'],
            ['key' => 'JWT_LOGIN_EMAIL', 'label' => 'JWT login email', 'type' => 'text',
             'help' => 'Grafana user in your stack/org (Viewer on dashboards)'],
            ['key' => 'JWT_TTL', 'label' => 'JWT lifetime (seconds)', 'type' => 'number', 'default' => 3600],
            ['key' => 'JWT_ISSUER', 'label' => 'JWT issuer (optional)', 'type' => 'text'],
            ['key' => 'DASHBOARDS', 'label' => 'Dashboards', 'type' => 'rows', 'keyed' => true,
             'columns' => [
                 ...
                 ['key' => 'url', 'label' => 'Dashboard URL', 'wide' => true,
                  'help' => 'Self-hosted /d/… · Cloud *.grafana.net/d/… · public …/public-dashboards/…'],
                 ['key' => 'jwt_auth', 'label' => 'JWT', 'type' => 'select', 'options' => ['auto', 'on', 'off'],
                  'help' => 'auto skips JWT for public-dashboard URLs'],
                 ['key' => 'jwt_email', 'label' => 'JWT email override'],
        ...
        'splunkdash' => ['title' => 'Splunk Published', 'file' => 'splunkdash.php', 'fields' => [
            ['key' => 'DASHBOARDS', 'label' => 'Published dashboards', 'type' => 'rows', 'keyed' => true,
             'columns' => [
                 ...
                 ['key' => 'crop_top', 'label' => 'Crop top (px)', 'cast' => 'int',
                  'help' => 'Shift iframe up to tuck Splunk title under the signage header (try 48–72)'],
             ]],
            ...
            ['key' => 'DEFAULT_CROP_TOP', 'label' => 'Default crop top (px)', 'type' => 'number',
             'help' => 'When blank per dashboard: 0 here = auto 50px crop while hide-chrome is on; set 0 on a dashboard row to disable crop'],
        ...
        'powerbi' => ['title' => 'Power BI', 'file' => 'powerbi.php', 'fields' => [
            ['key' => 'AZURE_TENANT_ID', 'label' => 'Azure tenant ID', 'type' => 'text',
             'help' => 'Entra ID directory (tenant) GUID — required for private reports'],
            ['key' => 'AZURE_CLIENT_ID', 'label' => 'Azure app (client) ID', 'type' => 'text',
             'help' => 'App registration used as Power BI service principal'],
            ['key' => 'AZURE_CLIENT_SECRET', 'label' => 'Azure client secret', 'type' => 'password',
             'help' => 'Client secret for embed-token auth (never commit to git)'],
            ['key' => 'DASHBOARDS', 'label' => 'Reports & dashboards', 'type' => 'rows', 'keyed' => true,
             'columns' => [
                 ['key' => '_key', 'label' => 'Key', 'help' => 'used in ?d='],
                 ['key' => 'title', 'label' => 'Title'],
                 ['key' => 'mode', 'label' => 'Mode', 'type' => 'select',
                  'options' => ['auto', 'publish', 'token'],
                  'help' => 'auto = publish URL or token when Azure is set'],
                 ['key' => 'url', 'label' => 'URL', 'wide' => true,
                  'help' => 'Publish: view?r=… · Private: reportEmbed URL or leave blank if IDs set'],
                 ['key' => 'workspace_id', 'label' => 'Workspace ID', 'help' => 'groupId — optional if in URL'],
                 ['key' => 'report_id', 'label' => 'Report ID'],
                 ['key' => 'dashboard_id', 'label' => 'Dashboard ID', 'help' => 'Use instead of report ID'],
                 ['key' => 'rls_username', 'label' => 'RLS username', 'help' => 'Optional effective identity'],
                 ['key' => 'rls_roles', 'label' => 'RLS roles', 'help' => 'Comma-separated role names'],
                 ['key' => 'reload', 'label' => 'Reload (s)', 'cast' => 'int'],
             ]],
            ['key' => 'DEFAULT_RELOAD', 'label' => 'Default iframe reload (s)', 'type' => 'number', 'help' => '0 disables; token boards refresh tokens automatically'],
            $tz,
        ]],
        ...
        'camwall' => ['title' => 'MDOT Cams', 'file' => 'camwall.php', 'fields' => [
            ...
            ['key' => 'COLS', 'label' => 'Grid columns', 'type' => 'number', 'default' => 3,
             'help' => 'Default 3 — paired with rows for tile count (3×4 = 12 cameras)'],
            ...
            ['key' => 'CAMS', 'label' => 'Cameras', 'type' => 'rows', 'keyed' => true,
             ...
             'columns' => [
                 ...
                 ['key' => 'route', 'label' => 'Route badge', 'help' => 'e.g. I-96, US-131'],
                 ['key' => 'url', 'label' => 'Snapshot URL', 'wide' => true,
                  'help' => 'MDOT micamerasimages.net .jpg or mdotjboss.state.mi.us RWIS still'],
                 ['key' => 'sort', 'label' => 'Order', 'cast' => 'int', 'help' => 'Lower = top-left first'],
                 ['key' => 'off', 'label' => 'Off', 'type' => 'bool'],
             ]],
            ['key' => 'REFRESH_SEC', 'label' => 'Image refresh (seconds)', 'type' => 'number',
             'help' => 'How often all tiles reload — default 45; staggered to reduce GPU load'],
            ['key' => 'RELOAD_SEC', 'label' => 'Page reload (seconds)', 'type' => 'number', 'default' => 600,
             'help' => 'Full page reload to flush Chromium — default 600; 0 disables'],
        ...
        'traffic' => ['title' => 'Traffic Map', 'file' => 'traffic.php', 'fields' => [
            ...
            ['key' => 'TITLE', 'label' => 'Board title', 'type' => 'text'],
            ['key' => 'SUBTITLE', 'label' => 'Subtitle', 'type' => 'text'],
            ['key' => 'LAT', 'label' => 'Map center latitude', 'type' => 'number', 'step' => 'any', 'default' => 42.968,
             'help' => 'Default 42.968 frames I-96 with Allendale on the left'],
            ['key' => 'LON', 'label' => 'Map center longitude', 'type' => 'number', 'step' => 'any', 'default' => -85.765,
             'help' => 'Less negative = east; default -85.765 shifts view toward Grand Rapids (Allendale left on screen)'],
            ['key' => 'ZOOM', 'label' => 'Zoom level', 'type' => 'number', 'default' => 12,
             'help' => '11 = full corridor; 12 = tighter Allendale / GR detail; 13 = metro close-up'],
            ['key' => 'SHOW_LABELS', 'label' => 'Street & highway labels', 'type' => 'bool', 'default' => true,
             'help' => 'Carto label overlay on top of traffic flow (I-96, M-45, city names, etc.)'],
            ['key' => 'SHOW_SCALE', 'label' => 'Distance scale bar', 'type' => 'bool', 'default' => true],
