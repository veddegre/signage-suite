...
function admin_schema(): array
{
    ...
    return [
        ...
        'webcam' => ['title' => 'Webcam', 'file' => 'webcam.php', 'fields' => [
            ...
            ['key' => 'ACTIVE', 'label' => 'Default camera', 'type' => 'text',
             'default' => 'gvsu',
             'help' => 'Built-in keys: gvsu, wetmet, grandhaven, or all to rotate. Custom keys from Cameras below. Plain webcam.php uses this.'],
            ['key' => 'CAMS', 'label' => 'Cameras', 'type' => 'rows', 'keyed' => true,
             'help' => 'Built-in feeds are always available; rows here override names/URLs or add your own. Use the key in ?cam=.',
             'columns' => [
                 ['key' => '_key', 'label' => 'Key', 'help' => 'used in ?cam='],
                 ['key' => 'name', 'label' => 'Display name'],
                 ['key' => 'url', 'label' => 'URL', 'wide' => true,
                  'help' => 'iframe src for live players (EarthCam, GVSU) or direct image URL (WetMet)'],
                 ['key' => 'kind', 'label' => 'Type', 'type' => 'select',
                  'options' => ['' => 'Auto', 'iframe' => 'Iframe embed', 'image' => 'Still image'],
                  'help' => 'Auto: image if URL looks like a photo endpoint, else iframe'],
            ...
            ['key' => 'IMAGE_REFRESH_SEC', 'label' => 'Image refresh (seconds)', 'type' => 'number',
             'help' => 'Still-image cameras (e.g. WetMet) — default 60'],
            ['key' => 'ROTATE_SEC', 'label' => 'Camera rotation (seconds)', 'type' => 'number',
             'help' => 'When default camera is “Rotate all” — default 90'],
