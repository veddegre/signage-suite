    ...
    return [
        ...
        'splunkdash' => ['title' => 'Splunk', 'file' => 'splunkdash.php', 'fields' => [
            ['key' => 'DASHBOARDS', 'label' => 'Published dashboards', 'type' => 'rows', 'keyed' => true,
             'columns' => [
                 ...
                 ['key' => 'crop_top', 'label' => 'Crop top (px)', 'cast' => 'int',
                  'help' => 'Shift iframe up to hide Splunk header/title (try 48–72)'],
             ]],
            ...
            ['key' => 'DEFAULT_CROP_TOP', 'label' => 'Default crop top (px)', 'type' => 'number',
             'help' => 'When blank per dashboard: 0 here = auto 104px crop while hide-chrome is on; set 0 on a dashboard row to disable crop'],
