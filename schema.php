    ...
    return [
        ...
        'kev' => ['title' => 'CISA KEV', 'file' => 'kev.php', 'fields' => [
            ...
            ['key' => 'WARN_DAYS', 'label' => 'Due-soon window (days)', 'type' => 'number',
             'help' => 'Highlight KEV entries with remediation due within N days (0–90, default 14)'],
            ['key' => 'WATCH_VENDORS', 'label' => 'Watch vendors', 'type' => 'text', 'wide' => true,
             'help' => 'Optional comma-separated vendor/product filters (e.g. microsoft, cisco). Blank = all vendors.'],
