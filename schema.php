...
function admin_schema(): array
{
    ...
    return [
        ...
        'glance' => ['title' => 'Today at a Glance', 'file' => 'glance.php', 'fields' => [
            ...
            ['key' => 'SHOW_HEADLINES_1', 'label' => 'Show headlines panel (left)', 'type' => 'bool', 'default' => true],
            ['key' => 'HEADLINES_1_TITLE', 'label' => 'Left panel title', 'type' => 'text', 'default' => 'GVNext'],
            ['key' => 'HEADLINES_1_PAGE_URL', 'label' => 'Headlines page URL', 'type' => 'text', 'wide' => true,
             'default' => 'https://www.gvsu.edu/gvnext/',
             'help' => 'GVNext homepage by default — autodiscovers RSS when present, otherwise scrapes article titles'],
            ['key' => 'HEADLINES_1_RSS', 'label' => 'Left panel RSS fallback', 'type' => 'text',
             'help' => 'Feed key from RSS Stories (rss.FEEDS) if the page has no feed or scrape fails'],
            ['key' => 'HEADLINES_1_MAX', 'label' => 'Left headlines shown', 'type' => 'number',
             'help' => 'How many titles to list (3–8, default 5)'],
            ['key' => 'SHOW_HEADLINES_2', 'label' => 'Show headlines panel (right)', 'type' => 'bool', 'default' => true],
            ['key' => 'HEADLINES_2_TITLE', 'label' => 'Right panel title', 'type' => 'text', 'default' => 'News'],
            ['key' => 'HEADLINES_2_RSS', 'label' => 'Right panel RSS feed key', 'type' => 'text',
             'help' => 'Key from RSS Stories admin (rss.FEEDS)'],
