    ...
    return [
        ...
        'grafana' => ['title' => 'Grafana', 'file' => 'grafana.php', 'fields' => [
            ['key' => 'JWT_ENABLED', 'label' => 'JWT auth for embed', 'type' => 'bool', 'default' => false,
             'help' => 'Sign short-lived auth_token URLs for SSO-protected self-hosted Grafana (see docs/grafana.md)'],
            ['key' => 'JWT_SECRET', 'label' => 'JWT signing secret', 'type' => 'password',
             'help' => 'Shared HS256 secret — must match Grafana auth.jwt JWK (kty oct)'],
            ['key' => 'JWT_KID', 'label' => 'JWT key ID (kid)', 'type' => 'text', 'default' => 'signage',
             'help' => 'Must match kid in Grafana jwk_set_file'],
            ['key' => 'JWT_LOGIN_EMAIL', 'label' => 'JWT login email', 'type' => 'text',
             'help' => 'Grafana user email for signage (Viewer) — must exist or enable auto_sign_up in Grafana'],
            ['key' => 'JWT_TTL', 'label' => 'JWT lifetime (seconds)', 'type' => 'number', 'default' => 3600,
             'help' => '300–86400; iframe refreshes before expiry'],
            ['key' => 'JWT_ISSUER', 'label' => 'JWT issuer (optional)', 'type' => 'text',
             'help' => 'Set only if Grafana auth.jwt expect_claims requires iss'],
            ['key' => 'DASHBOARDS', 'label' => 'Dashboards', 'type' => 'rows', 'keyed' => true,
             'columns' => [
                 ...
                 ['key' => 'url', 'label' => 'Dashboard URL', 'wide' => true,
                  'help' => 'Normal /d/… URL from browser (not the SSO login redirect)'],
                 ['key' => 'jwt_email', 'label' => 'JWT email override', 'help' => 'Optional per-row Grafana user'],
