...
- **Slide creator:** same page — start from an occasion **template** (Birthday, Anniversary, etc.) with themed artwork baked into the PNG, or pick a **Photo scene** background (curated Unsplash/Pexels photography, dimmed with a vignette so text stays readable) or a **Theme color** gradient. Full-width edit fields, live preview at 1920×1080, **Create slide** saves into `./slides/`. Photo credits in `slide_backgrounds/photos/CREDITS.md`.
