...
function slide_theme_background_presets(): array
{
    return [
        ...
        // GVSU identity — primary blue page; secondary accents — https://www.gvsu.edu/identity/color-2
        'gvsu_lakers' => [
            'label' => 'GVSU',
            'title' => '#FFFFFF',
            'subtitle' => '#DEC197',
            'highlight' => '#DEC197',
            'signage_page' => '#0032A0',
            'signage_harbor' => '#002878',
            'signage_ticker_bar' => '#0032A0',
            'signage_beacon' => '#0ECBF0',
            'body' => '#c8d8f0',
            'footer' => '#3DD1CC',
            'bg' => ['type' => 'linear', 'angle' => 145, 'stops' => [
                [0, '#0032A0'], [0.55, '#13155C'], [1, '#0032A0'],
            ]],
            'accent' => ['type' => 'bar', 'color' => '#0ECBF0', 'width' => 12],
...
function slide_creator_templates(): array
{
    return [
        ...
        'dinner_menu' => [
            ...
            'subtitle' => '[Day, Month Date]',
            'body' => "[Main dish]\n[Side] · [Side]\n[Dessert or note]",
            'footer' => 'Kitchen',
            'filename' => 'dinner-menu',
        ],
        'house_reminder' => [
            'label' => 'House reminder',
            'bg' => 'photo_reminder',
            'align' => 'left',
            'title' => '[Reminder]',
            'subtitle' => '[When]',
            'body' => "[Details — trash, packages, thermostat, etc.]",
            'footer' => '',
            'filename' => 'house-reminder',
        ],
        'anniversary' => [
            'label' => 'Anniversary',
            'bg' => 'photo_romantic_dinner',
            ...
            'body' => "Celebrating together today.\nDinner at [Time] — [Place or plan]",
            'footer' => 'Love always',
        ...
        'snow_day' => [
            ...
            'title' => 'Snow Day',
            'subtitle' => '[Date]',
            'body' => "[School / office status]\n[Late start time or all clear message]",
            'footer' => 'Stay warm & safe',
            'filename' => 'snow-day',
        ],
    ];
}
...
{
    return SIGNAGE_ROOT . '/slide_backgrounds';
}
