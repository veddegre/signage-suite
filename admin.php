...
$navGroups = [
    ...
    'Monitoring'      => ['homelab', 'outages', 'internet', 'attacks', 'dshieldmap', 'radar', 'attackmap', 'hibp', 'cve', 'signaltrace', 'zabbix'],
...
function rotationLabelFromUrl(url) {
  ...
  const boards = {
    ...
    'calendar.php': 'Calendar', 'family.php': 'Calendar', 'traffic.php': 'Traffic map', 'air.php': 'Air & pollen', 'uv.php': 'UV index', 'wotd.php': 'Word of the day', 'history.php': 'This day in history', 'joke.php': 'Dad jokes', 'xkcd.php': 'XKCD comic', 'outages.php': 'Cloud outages', 'internet.php': 'Internet infrastructure', 'attacks.php': 'Internet attacks', 'dshieldmap.php': 'DShield heatmap', 'radar.php': 'Cloudflare Radar', 'attackmap.php': 'Attack map', 'hibp.php': 'Data breaches', 'cve.php': 'New CVEs', 'sports.php': 'Detroit sports', 'homelab.php': 'Homelab status',
